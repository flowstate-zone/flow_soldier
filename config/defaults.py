...
_C.DATASETS.TRAIN_NAMES = ["urbnsurf-melbourne_left"]
_C.DATASETS.VAL_NAMES = ["urbnsurf-melbourne_left"]
_C.DATASETS.TRAIN_LIMIT = None
_C.DATASETS.VAL_LIMIT = None
...
_C.S3_REVIEWED_DATA = ["reid-data/pretraining-sessions/urbnsurf-melbourne"]