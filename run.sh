...
CUDA_VISIBLE_DEVICES=0 CUDA_LAUNCH_BLOCKING=1 python train.py --config_file configs/flowstate/surftown-munich_sessions.yml MODEL.PRETRAIN_CHOICE 'self' MODEL.PRETRAIN_PATH './log/swin_small.pth'  OUTPUT_DIR './log/flowstate/surftown-munich_sessions-masked-pre-trained'
