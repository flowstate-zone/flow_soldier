# Swin Base
CUDA_VISIBLE_DEVICES=0 CUDA_LAUNCH_BLOCKING=1 python train.py --config_file configs/flowstate/urbnsurf-melbourne.yml MODEL.PRETRAIN_CHOICE 'self' MODEL.PRETRAIN_PATH './log/swin_small_tea.pth'  OUTPUT_DIR './log/flowstate/urbnsurf-melbourne'
