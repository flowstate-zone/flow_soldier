# Swin Base
CUDA_VISIBLE_DEVICES=0 python train.py --config_file configs/flowstate/urbnsurf-melbourne.yml MODEL.PRETRAIN_CHOICE 'self' MODEL.PRETRAIN_PATH './log/swin_small_tea.pth' MODEL.RESUME './log/flowstate/urbnsurf-melbourne/transformer_60.pth' OUTPUT_DIR './log/flowstate/urbnsurf-melbourne' SOLVER.BASE_LR 0.0002 SOLVER.OPTIMIZER_NAME 'SGD' MODEL.SEMANTIC_WEIGHT 0.2
